...
variability regarding the dominant form of nitrogen.  The proportion of
...
few day, we'd expect very low N concentrations on the Presumspcot, but that
...
Note that since we are modeling two transformed variables, we need to specify
...
1.  Back transform coordinates of our prediction and then transform the axes 
    again for display.  
